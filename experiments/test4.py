...
# DeepD3 
from model_ln import DeepD3_Model
...
# Callbacks
mc = ModelCheckpoint("Experiment_LN.weights.h5", save_best_only=True,save_weights_only=True)
csv = CSVLogger("Experiment_LN.csv")
...
# Save model weights
m.save("Experiment_LN.h5",save_format='h5')
